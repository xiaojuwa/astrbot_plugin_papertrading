...
class Formatters:
    ...
    def format_stock_info(stock_info: Dict[str, Any]) -> str:
        ...
        lines = [
            ...
            f"💱 买一: {stock_info['bid1_price']:.2f} 卖一: {stock_info['ask1_price']:.2f}",
            f"🔄 成交量: {Formatters.format_currency(stock_info['volume'])}股"
        ]
...
💰 交易指令:
/买入 代码 数量 [价格] - 买入股票
  例: /买入 000001 1000 (市价买入)
  例: /买入 000001 1000 12.50 (限价买入)

/卖出 代码 数量 [价格] - 卖出股票
  例: /卖出 000001 500 (市价卖出)
  例: /卖出 000001 500 13.00 (限价卖出)
...
💡 提示: 股票代码格式如 000001、600000、300001"""
